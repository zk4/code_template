...
__homepage__ = 'https://github.com/zk4/bestpractice'
...
if __name__ == '__main__':
    setup(
        ...
        package_data={'bestpractice.logx': ['logging.yaml']},
        install_requires=open('requirements.txt', 'r').read().strip().split(),
        entry_points={
            'console_scripts': [
                'bestpractice = bestpractice:entry_point'
            ]
        },
        classifiers=[
