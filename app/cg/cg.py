...
def createParse():
    ...
    parser.add_argument('-l', '--link_tplt', help='link cwd template to CG_TMPLS', default=False, action='store_true' ,) 
    parser.add_argument('-c', '--cp_tplt', help='make cwd template to CG_TMPLS', default=False, action='store_true' ,) 
