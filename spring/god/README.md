# intro
suppose you want to make a comand line tool called god.
...
You can see that `main.py` and `god/__main__.py` are the same  content file.
...
So , why `god/__main__.py` does not work?

because top-level package is god now.
